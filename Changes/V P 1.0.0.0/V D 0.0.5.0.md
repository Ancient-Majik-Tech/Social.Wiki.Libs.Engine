[Page]:https://github.com/Ancient-Majik-Tech/Social.Wiki.Libs.Engine/blob/main/Changes/V%20P%201.0.0.0/V%20D%200.0.5.0.md
...
# Realms Tutorial Collections: "Realms Engine" [ Changes - V D 0.0.5.0 ]

Welcome for the Update page for V D 0.0.5.0 here you can learn about what happened in this release.
...
This Update was focused on updating the current engine library to be moved to use [Realms Core][Page Libs.Core] over the previous prototypes that where testing for it.
...
- Project Changes
	...
	- Dependancies
		- New
			- [Realms Core][Page Libs.Core]
		- Removed
			- Old Prototype Libraries
	- Child Projects
		- New
